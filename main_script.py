...
n_itr_rigid = 0
n_itr_nonRigid = 500                                                               # 250 -> 2000 (good: 500) -  for all resolutions
n_res = 3                                                                           # default: 4     (used for all registrations)
...
for rigid_alignment_transform__filename in arr__rigid_alignment_transform__filename:
    I_deformed_filename = f'{I_m}_vol_deformed_to_{I_f}___rigidAlignment={rigid_alignment_transform__filename.split("__")[3].split(".")[0]}___OC_&_PC_3x___nItr=500___nRes=3.nii'
