...
## 3D
outFldr = "run_elastix__DRAFT"              # DRAFT  -  result_meansSqr_rgdPen_2d  -  result_meansSqr_rgdPen  -  result_meansSqr_rgdPen_2d_with_fixedMask  -
parMapFile = "2x4__DRAFT__fnlGrdSpc-8/pMap0.txt"              # Par0016.multibsplines.lung.sliding.txt  -  Par_3d.txt
i_f = "R1_.bmp"                   # R1_mask_allBones_xtnd.nii  -  R1_2d.bmp  -  R1_vol_uncropd
i_m = "R4_.bmp"                   # R4_mask_allBones_tnd.nii  -  R4_2d.bmp
